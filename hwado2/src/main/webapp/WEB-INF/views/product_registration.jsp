...
<head>
    ...
    <link href="resources/assets/css/product_registration.css" rel="stylesheet">
...
<div class="menu-bar">
    <ul class="menu-items">
        ...
        <li><a href="product_registration.html" id="fv_at">작품등록</a></li>
...
<main class="product-container">
    <form class="product-form" action="prd_regi" method="post" enctype="multipart/form-data">
        ...
        <div class="form-section">
            ...
            <!-- 가격 입력 필드 -->
            <div class="input-group">
                <label for="cost" class="input-label">가격</label>
                <input type="text" name="aw_price" id="cost" class="input-field" placeholder="가격을 입력하세요" required />
            ...
            <div class="input-group">
                ...
                <select name="category_seq" id="category" class="select-category" required>
                    <option value="1">추상화</option>
                    <option value="2">풍경화</option>
                    <option value="3">정물화</option>
                    <option value="4">공예품</option>
